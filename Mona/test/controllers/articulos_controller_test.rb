...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { color: @articulo.color, marca: @articulo.marca, name: @articulo.name } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { color: @articulo.color, marca: @articulo.marca, name: @articulo.name } }
